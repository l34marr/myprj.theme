...
#
#  $ bin/test -s myprj.theme -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src myprj.theme.testing.MYPRJ_THEME_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/myprj/theme/tests/robot/test_example.robot
#
